...
namespace Capa_Vista
{
    public partial class frmReferenciaPersonal : Form
    {
        ...
        {
            this.dtgReferenciaPersonal.DataSource = nReferenciaPersonal.Mostrar();
            this.OcultarColumnas();
            lblTotal.Text = "Total de Registros: " + Convert.ToString(dtgReferenciaPersonal.Rows.Count);
        }
        ...
        {
            this.dtgReferenciaPersonal.DataSource = nReferenciaPersonal.Buscar(this.txtBuscar.Text);
            lblTotal.Text = "Total de Registros: " + Convert.ToString(dtgReferenciaPersonal.Rows.Count);
        }
        ...
        private void dtgReferenciaPersonal_DoubleClick(object sender, EventArgs e)
        {
            if (this.dtgReferenciaPersonal.CurrentRow != null)
            {
                if(btnNuevo.Enabled != false)
                {
                    ...
                    string Persona = dtgReferenciaPersonal.CurrentRow.Cells["Persona"].Value.ToString();
