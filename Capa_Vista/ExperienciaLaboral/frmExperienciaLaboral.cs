...
namespace Capa_Vista.ExperienciaLaboral
{
    public partial class frmExperienciaLaboral : Form
    {
        ...
        private static ExperienciaLaboralFormulario instanciaAbierta = null;
        ...
        //Evento para movilizar el formulario
        ...
        private void OcultarColumnas()
        {
            ...
            try
            {
                ...
                if (this.dtgExperiencia.Columns.Count > 0)
                {
                    this.dtgExperiencia.Columns[0].Visible = false;
                }
                else
                {
        ...
        private void dtgExperiencia_MouseClick(object sender, MouseEventArgs e)
        {
            if (e.Button == MouseButtons.Right)
            {
                var hti = dtgExperiencia.HitTest(e.X, e.Y);
                if (hti.RowIndex >= 0)
                {
                    dtgExperiencia.Rows[hti.RowIndex].Selected = true;
                }
            }
                ...
                else if (id.Contains("Eliminar"))
                {
                    if (instanciaAbierta == null || instanciaAbierta.IsDisposed)
                    {
                        ...
                        if (result == DialogResult.Yes)
                        {
                            ...
                            string rpta = "";
                            int Id = Convert.ToInt32(this.dtgExperiencia.CurrentRow.Cells["ID"].Value);
                            rpta = nExperienciaLaboral.Eliminar(Id);
                            if (rpta.Equals("OK"))
                            {
