...
{
    public partial class frmTomaPosesion : Form
    {
        public frmTomaPosesion()
        {
            InitializeComponent();
        }

        private void frmTomaPosesion_Load(object sender, EventArgs e)
        {
        ...
        private void btnGenerar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                ReplaceBookmark(doc, "FechaLetras1", txtFechaLetras1.Text);
                ...
                ReplaceBookmark(doc, "Renglon", txtRenglon.Text);
                ReplaceBookmark(doc, "Salario", txtSalario.Text);
                ReplaceBookmark(doc, "SalarioLetras", txtSalarioLetras.Text);
        ...
        public void CargarDatos(string dpi, string puestofuncional, string puestonominal,
           string profesion, string empleado,string salario, string renglon)
        {
